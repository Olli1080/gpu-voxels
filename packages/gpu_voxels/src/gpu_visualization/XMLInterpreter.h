...
namespace gpu_voxels {
	namespace visualization {
		...
		public:
			 ...
			 */
			[[nodiscard]] bool getVisualizerContext(const std::unique_ptr<VisualizerContext>& con) const;
			 ...
			 * \return true if context was found
			 */
			bool getVoxelmapContext(VoxelmapContext& context, uint32_t index = 0) const;
			 ...
			 * \return true if context was found
			 */
			bool getVoxellistContext(CubelistContext& context, uint32_t index = 0) const;
			 ...
			 * \return true if context was found
			 */
			bool getOctreeContext(CubelistContext& context, uint32_t index) const;
			 ...
			 * \return true if context was found
			 */
			bool getPrimitiveArrayContext(PrimitiveArrayContext& context, uint32_t index) const;
			 ...
			 */
			void getPrimitives(std::vector<std::unique_ptr<Primitive>>& primitives) const;

			/*!
			 * \brief getDefaultSphere specifies a sphere with a unit radius and 16 facetes.
			 * \param sphere which is defined
			 */
			void getDefaultSphere(std::unique_ptr<Sphere>& sphere) const;

			/*!
			 * \brief getDefaultCuboid specifies a unit cube
			 * \param cuboid which is defined
			 */
			void getDefaultCuboid(std::unique_ptr<Cuboid>& cuboid) const;
		...
		private:
			 ...
			 */
			bool getXYZFromXML(glm::vec3& position, const std::filesystem::path& c_path, float default_value) const;
			 ...
			 */
			static glm::vec3 colorNameToVec3(const std::string& name);
			 ...
			 */
			bool getColorFromXML(glm::vec4& color, std::filesystem::path c_path) const;
			 ...
			 * \return true if parameters were found
			 */
			bool getColorPairFromXML(colorPair& colors, const std::filesystem::path& c_path) const;
			 ...
			 */
			[[nodiscard]] std::pair<float, std::string> getUnitScale() const;
			 ...
			 */
			bool getDataContext(DataContext& context, const std::string& name) const;
			 ...
			 * \return true if parameters were found
			 */
			bool getSphereFromXML(std::unique_ptr<Sphere>& sphere, const std::string& name) const;
			 ...
			 * \return true if parameters were found
			 */
			bool getCuboidFromXML(std::unique_ptr<Cuboid>& cuboid, const std::string& name) const;
			 ...
			 */
			[[nodiscard]] std::unique_ptr<Camera_gpu> getCameraFromXML() const;
