...
int main(int argc, char* argv[])
{
	...
	*/
	...
	gvl->initialize(200, 200, 100, 0.02f);
	...
	/*
	auto kinect = std::make_unique<Kinect>(identifier);
	kinect->run();
	...
	kinect_dh_params[0] = robot::DHParameters(0.0, 0.0, 0.0, -1.5708f, 0.0, robot::PRISMATIC); // Params for Y translation
	kinect_dh_params[1] = robot::DHParameters(0.0, -1.5708f, 0.0, -1.5708f, 0.0, robot::PRISMATIC); // Params for X translation
	kinect_dh_params[2] = robot::DHParameters(0.0, 1.5708f, 0.0, 1.5708f, 0.0, robot::PRISMATIC); // Params for Pan axis
	kinect_dh_params[3] = robot::DHParameters(0.0, 1.5708f, 0.0, 1.5708f, 0.0, robot::REVOLUTE);  // Params for Tilt axis
	kinect_dh_params[4] = robot::DHParameters(0.0, 0.0, 0.0, -3.1415f, 0.0, robot::REVOLUTE);  // Params for Kinect
	...
	*/
	...
	constexpr int num_swept_volumes = 50;// < BIT_VECTOR_LENGTH;
	...
	{
		constexpr float ratio_delta = 0.02;
