...
#ifndef GPU_VOXELS_HELPERS_GEOMETRY_GENERATION_H_INCLUDED
#define GPU_VOXELS_HELPERS_GEOMETRY_GENERATION_H_INCLUDED
...
namespace gpu_voxels
{
    ...
    namespace geometry_generation
    {
         ...
         * \param points
         */
        void createEquidistantPointsInBox(size_t max_nr_points,
                                          Vector3ui max_coords,
                                          float side_length,
         ...
         * \param white_points
         */
        void createNonOverlapping3dCheckerboard(size_t max_nr_points,
                                                Vector3ui max_coords,
                                                float side_length,
