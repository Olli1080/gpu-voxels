...
namespace gpu_voxels {
	...
	inline SVCollider::SVCollider(const float coll_threshold, const size_t window_size) :
	...
	inline SVCollider::SVCollider(const Probability threshold1, const Probability threshold2, const size_t window_size) :
	...
	inline bool SVCollider::collide(const ProbabilisticVoxel& v1, const ProbabilisticVoxel& v2) const
	{
		return v1.getOccupancy() >= m_threshold1 && v2.getOccupancy() > m_threshold2;
	}

	inline bool SVCollider::collide(const ProbabilisticVoxel& v1) const
	{
	...
	inline Probability SVCollider::floatToProbability(const float val)
	{
