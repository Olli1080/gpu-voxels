...
protected:
  ...
  parallel::device_vector<Voxel> *d_free_space_voxel2;
  parallel::device_vector<Voxel> *d_object_voxel2;
  bool m_internal_buffer_1;
  parallel::device_vector<Cube> *m_d_cubes_1;
  parallel::device_vector<Cube> *m_d_cubes_2;
};
