...
namespace gpu_voxels
{
	namespace NTree
	{
		namespace LoadBalancer
		{
			...
			{
			public:
				static constexpr int NUM_BALANCE_THREADS = _num_threads;
				static constexpr int NUM_TRAVERSAL_THREADS = _num_threads;
			};
			...
			public:
				 ...
				 */
				AbstractLoadBalancer(float idle_threshold = DEFAULT_IDLE_THESHOLD, uint32_t num_tasks = 2688);
			...
			protected:
				 ...
				 */
				static constexpr std::size_t STACK_SIZE_PER_TASK = 700;
