	...
	namespace NTree
	{
		...
		namespace LoadBalancer
		{
			...
			public:
				...
				*/
				Intersect(
					const NTree<branching_factor, level_count, InnerNode, LeafNode>* ntree_a,
					const NTree<branching_factor, level_count, InnerNode2, LeafNode2>* ntree_b,
			...
			protected:
				...
				const NTree<branching_factor, level_count, InnerNode, LeafNode>* m_ntree_a;
				const NTree<branching_factor, level_count, InnerNode2, LeafNode2>* m_ntree_b;
