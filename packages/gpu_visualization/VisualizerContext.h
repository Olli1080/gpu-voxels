	...
	namespace visualization {
		...
		struct VisualizerContext
		{
			VisualizerContext()
				...
				m_max_voxelmap_dim(Vector3ui::Zero()),
				...
				m_grid_max_x(1000.f),
				m_grid_max_y(1000.f),
				m_draw_edges_of_triangles(false),
				m_draw_filled_triangles(true),
				m_draw_whole_map(false),
				m_draw_grid(true),
				m_draw_collision_depth_test_always(false),
			...
			std::vector<std::unique_ptr<VoxelmapContext>> m_voxel_maps;

			// the voxel lists of this context
			std::vector<std::unique_ptr<CubelistContext>> m_voxel_lists;

			// the voxel maps of this context
			std::vector<std::unique_ptr<CubelistContext>> m_octrees;

			// the primitive arrays of this context
			std::vector<std::unique_ptr<PrimitiveArrayContext>> m_prim_arrays;
			...
			bool m_draw_edges_of_triangles;
			bool m_draw_filled_triangles;
			bool m_draw_whole_map;
			bool m_draw_grid;
			bool m_draw_collision_depth_test_always;
			...
			std::unique_ptr<Camera_gpu> m_camera;
