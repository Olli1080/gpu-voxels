...
namespace gpu_voxels {
    namespace visualization {
        ...
        public:
            ...
            void resizeFunction(int32_t width, int32_t height) const;
            void renderFunction(void);
            void idleFunction() const;
            ...
            */
            ...
            void keyboardSpecialFunction(int32_t key, int32_t x, int32_t y) const;
            void mouseMotionFunction(int32_t xpos, int32_t ypos) const;
            void mousePassiveMotionFunction(int32_t xpos, int32_t ypos) const;
            /**
            * <ul>
            ...
            */
            ...
            void registerVoxelMap(voxelmap::AbstractVoxelMapVisual* map, uint32_t index, std::string map_name);
            ...
            [[nodiscard]] size_t getMaxMem() const
            {
                return m_max_mem;
            }

            void setMaxMem(size_t maxMem)
            {
                m_max_mem = maxMem;
            }

            [[nodiscard]] std::vector<std::string> getVoxelMapNames() const;
            [[nodiscard]] std::vector<std::string> getVoxelListNames() const;
            [[nodiscard]] std::vector<std::string> getOctreeNames() const;
            [[nodiscard]] std::vector<std::string> getPrimitiveArrayNames() const;
        ...
        private:
            ...
            void createGridVBO() const;
            void createFocusPointVBO() const;
            ...
            void drawDataContext(const DataContext& context);
            void drawGrid() const;
            void drawFocusPoint() const;
            void drawHelperPrimitives() const;
            void drawPrimitivesFromSharedMem() const;
			...
			*/
            ...
            void updateStartEndViewVoxelIndices() const;
            bool updateOctreeContext(CubelistContext& context, uint32_t index) const;
            bool updateVoxelListContext(CubelistContext& context, uint32_t index) const;

            void increaseSuperVoxelSize() const;
            void decreaseSuperVoxelSize() const;

            void renderFrameWithColorMap(uint32_t, const DataContext&) const;
            uint32_t getDataPositionFromColorMap(int32_t x, int32_t y, uint32_t axis, const DataContext& con) const;

            void distributeMaxMemory() const;

            void flipDrawVoxelmap(uint32_t index) const;
            void flipDrawOctree(uint32_t index) const;
            void flipDrawVoxellist(uint32_t index) const;
            void flipDrawPrimitiveArray(uint32_t index) const;
            void flipDrawType(BitVoxelMeaning type) const;
            void flipDrawSweptVolume();
            void flipExternalVisibilityTrigger();
            void copyDrawTypeToDevice() const;
            void updateTypesSegmentMapping(DataContext& context) const;
            __inline__ uint8_t typeToColorIndex(uint8_t type);

            void toggleLighting() const;

            void printHelp();
            [[nodiscard]] std::string printViewInfo() const;
            [[nodiscard]] std::string printNumberOfVoxelsDrawn() const;
            [[nodiscard]] std::string printTotalVBOsizes() const;
            [[nodiscard]] std::string printPositionOfVoxelUnderMouseCursor(int32_t xpos, int32_t ypos) const;
            void log();
            void logCreate();

            void rotate_slice_axis() const;
            void move_slice_axis(int offset) const;


            //keyboard helper
            void keyboardFlipVisibility(glm::int8_t index) const;
            ...
            /**
              ...
              */
            void drawTextLine(std::string text, int x, int y) const;

            /**
              * Draws multiple lines of text divided by a \n on the screen. (0,0) is the lower left corner of the screen.
              */
            void drawText(std::string, int x, int y) const;
            /////////////////////////////////////////member variables//////////////////////////////////////////
              // the current context of the visualizer
            std::unique_ptr<VisualizerContext> m_cur_context;
            ...
            std::unique_ptr<XMLInterpreter> m_interpreter;
            std::unique_ptr<SharedMemoryManagerOctrees> m_shm_manager_octrees;
            std::unique_ptr<SharedMemoryManagerVoxelMaps> m_shm_manager_voxelmaps;
            std::unique_ptr<SharedMemoryManagerVoxelLists> m_shm_manager_voxellists;
            std::unique_ptr<SharedMemoryManagerPrimitiveArrays> m_shm_manager_primitive_arrays;
            std::unique_ptr<SharedMemoryManagerVisualizer> m_shm_manager_visualizer;
