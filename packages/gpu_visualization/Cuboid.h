...
namespace gpu_voxels {
	namespace visualization {
		...
		public:
			...
			{
				const auto n_neg_x = glm::vec3(-1, 0, 0);
				const auto n_pos_x = glm::vec3(1, 0, 0);

				const auto n_neg_y = glm::vec3(0, -1, 0);
				const auto n_pos_y = glm::vec3(0, 1, 0);

				const auto n_neg_z = glm::vec3(0, 0, -1);
				const auto n_pos_z = glm::vec3(0, 0, 1);
				...
				vertices.emplace_back(x, y, _z);
				vertices.emplace_back(x, _y, z);
				if (with_lighting)
				{
				...
				vertices.emplace_back(_x, y, z);
				vertices.emplace_back(_x, _y, z);
				vertices.emplace_back(_x, y, _z);
				if (with_lighting)
				{
				...
				vertices.emplace_back(_x, _y, z);
				vertices.emplace_back(_x, _y, _z);
				vertices.emplace_back(_x, y, _z);
				if (with_lighting)
				{
					vertices.push_back(n_pos_x);
